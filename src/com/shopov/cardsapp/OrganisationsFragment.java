...
public class OrganisationsFragment extends Fragment implements LocationListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    	...
    	ArrayAdapter<String> citiesAdapter = new ArrayAdapter<String>(getActivity(), android.R.layout.simple_spinner_item, listCities);
    	...
    	adapter = new OrganisationsAdapter(getActivity(), organisationsList, myLocation);
